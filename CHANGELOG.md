...
- **Replaced kramdown with CommonMark** to avoid direct rexml dependency
  ...
  - While Jekyll core still has kramdown as a transitive dependency (unavoidable in current Jekyll architecture), the site's markdown content is now processed entirely by CommonMark
