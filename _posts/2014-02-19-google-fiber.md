...
author: cwage
layout: post
guid: http://chris.quietlife.net/?p=3881
permalink: /2014/02/19/google-fiber/
aktt_notify_twitter:
  - yes
aktt_tweeted:
  - 1
...
> 
> You bring up a lot of technical points (and there is \_some\_ counter argument to them) but the bigger reason why I was non plussed about the announcement (again, more providers in a market is a good thing) is less about technical and more about economics and consumer empowerment. 
> 
...
To clarify succinctly: I don't care if Google wants to come compete. I have no problem with that. The excitement to me is ill-informed, and the minute that our political class attempts to turn that excitement into government-subsidized incentives for Google, you'll see me raise holy hell. (Or, more realistically, post a whiny blog entry and go back to work.)
 ...
 [1]: http://en.wikipedia.org/wiki/Tanstaafl
 [2]: http://chris.quietlife.net/2011/11/21/a-eulogy-for-google-reader/
