...
author: cwage
layout: post
guid: http://chris.quietlife.net/?p=2427
permalink: /2009/09/16/tonemap-this/
aktt_notify_twitter:
  - yes
ljxp_comments:
  - 0
...
tags:
  ...
  - tonemapping
---
Okay, people. There's a disturbing trend and it needs to stop. Photoshop CS3 (and maybe CS2) incorporated the ability to tonemap an image. [Tonemapping][1] is basically where you take an image with higher dynamic range and compress it down to a normal 8-bit image. An imperfect but suitable analogy is compression in the world of audio processing. (sortof). Anyways, it's a technique that is used often with HDR, because HDR is a process where you end up with a 16 bit image, but you have to show it to the 8-bit world, somehow, so you tonemap it.
...
**UPDATE:** I hope no one I know took/processed this picture. If so, uhm, hi! I still like you.
 ...
 [1]: http://en.wikipedia.org/wiki/Tone_mapping