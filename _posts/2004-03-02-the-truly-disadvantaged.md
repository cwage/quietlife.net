...
author: cwage
layout: post
guid: http://wordpress.quietlife.net/?p=275
permalink: /2004/03/02/the-truly-disadvantaged/
dsq_thread_id:
  - 236777518
categories:
  - politics
tags:
  - politics
---
Ever read a column that is so unfathomably stupid, you find yourself re-reading each paragraph to make sure you read it right? Ever read a column that makes you so angry that you have to pause in between paragraphs, shaking with rage?

David Brooks has written [one of those][1] today. Here's a taste:  
<!--more-->
...
He also has the audacity to quote [The Truly Disadvantaged][3], one book that firmly and methodically rips apart the "culture of poverty" ignorance that he is spewing.
